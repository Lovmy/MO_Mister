...
if not os.path.isfile("logo_cartouche_16k.rom"):
	print("\n\n  Missing 'logo_cartouche_16k.rom'\n\n")	
    exit()

   
#fou = open("rom_pack.vhd","w")
fou = open("rom_logo.vhd","w")
fou.write("LIBRARY IEEE;\nUSE IEEE.std_logic_1164.ALL;\nUSE IEEE.numeric_std.ALL;\n");
#fou.write("PACKAGE rom_pack IS\n");
fou.write("PACKAGE rom_logo IS\n");
fou.write("\n");
...
gen("ROM_MO5_LOGO","logo_cartouche_16k.rom")
